...
class Receiptcards extends CRMEntity {
	...
	function getSortOrder() {
		...
		else if($_SESSION['Receiptcards_Sort_Order'])
		$sortorder = $_SESSION['Receiptcards_Sort_Order'];
		return $sortorder;
	}
	...
	function getOrderBy() {
		...
		else if($_SESSION['Receiptcards_Order_By'])
		$orderby = $_SESSION['Receiptcards_Order_By'];
		return $orderby;
	}
